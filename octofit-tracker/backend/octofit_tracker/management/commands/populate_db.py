...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create workouts
        Workout.objects.create(name='Full Body Blast', difficulty='Hard')
        Workout.objects.create(name='Morning Yoga', difficulty='Easy')
        Workout.objects.create(name='Cardio Burn', difficulty='Medium')
